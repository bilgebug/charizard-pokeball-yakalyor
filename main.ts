controller.A.onEvent(ControllerButtonEvent.Pressed, function () {
    if (charizard.overlapsWith(pokeball)) {
        game.over(true)
    } else {
        info.changeLifeBy(-1)
    }
...
game.splash("Charizard pokeball yaakalıyor")
game.showLongText("Pokeballu yakalmak için A ya bas", DialogLayout.Bottom)
...
charizard = sprites.create(img`
    ...
    . . c c c c c d 4 4 c . . . . . 
    `, SpriteKind.Player)
controller.moveSprite(charizard)
charizard.setPosition(85, 100)
